...
config_file = "configs/oidv5/cascade_rcnn_cls_aware_r200_vd_fpn_dcnv2_nonlocal_softnms.yml"
opt= {'weights': 'oidv5_cascade_rcnn_cls_aware_r200_vd_fpn_dcnv2_nonlocal_softnms'}
...
if __name__ == "__main__":
    ...
    for message in consumer_easyocr:
        ...
        print("MESSAGE RECEIVED consumer_OPEN_IMAGES: ")
